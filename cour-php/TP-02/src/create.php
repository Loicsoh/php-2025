...
function clean_input($data)
{
    ...
    margin:15px;"> Veillez remplir les champs </span>';
    } else {
...
<h1 class="text-3xl font-bold text-green-900 text-center mb-4">Créer un
nouveau Etudiant</h1>
<?= $message ?>
...
class="inline-block px-4 py-2 bg-green-600 text-white rounded hover:bggreen-700">
</div>
</form>
