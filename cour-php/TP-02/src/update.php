...
$message = '<span style="background:red; padding:10px; color:white;
margin:15px;"> Veuillez remplir tous les champs </span>';
} else {
...
$sql = "UPDATE etudiants SET nom=:nom, prenom=:prenom, mail=:mail
WHERE id=:etudiantID";
$query = $pdo->prepare($sql);
...
<h1 class="text-3xl font-bold text-green-900 text-center mb-4">Modifier un
étudiant</h1>
<?= $message ?>
...
php2025/crud-student-php-prof-2025/">Liste
des étudiants
</a>
</div>
</body>
